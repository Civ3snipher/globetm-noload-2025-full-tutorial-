...
4.open vip snipher select server gtm no load and select payload gtm no load and connect

5.make sure na naka set up apn phone setting nyo sa ipv6 only para mag work.

6.flight mode if no browze and connect
7.enjoy and happy surfing guyz🥰
